        ...
        return {
            ...
            draw: function (source, layout) {
                ...
                node.select('rect.nodeShape')
                    ...
                    .attr({
                        "rx": function (d) {
                            return getNodeAttr("rx", d)
                        },
                        "ry": function (d) {
                            return getNodeAttr("ry", d)
                        },
                        "x": function (d) {
                            return getNodeAttr("x", d)
                        },
                        "y": function (d) {
                            return getNodeAttr("y", d)
                        },
                        "width": function (d) {
                            return getNodeAttr("width", d)
                        },
                        "height": function (d) {
                            return getNodeAttr("height", d)
                        },
                        "transform": function (d) {
                            return getNodeAttr("transform", d)
                        }
                    })
                    .style('display', function (d) {
                    ...
                    .style("fill", function (d) {
                        ...
                        // Priority coloring
                        if (d.meta.color.taxa) {
                            fill = d.meta.color.taxa
                        }
                        if (d.meta.color.node) {
                            fill = d.meta.color.node
                        }
                        if (d._children) {
                            fill = nodeColorClosed;
                        }
                        return fill;
                    })
                ...
                link.transition()
                    ...
                    .attr("d", function (d) {
                        ...
                        if (settings.activeTransform === 'linear') {
                            ...
                            switch (linkProjection) {
                                case "elbow":
                                    return elbowRadial(d);
                                    break;
                                case "diagonal":
                                    return diagonalRadial(d);
                                    break;
                                case "direct":
                                    return directRadial(d);
                                    break;
                            }
                        }
                    })
                ...
                linkText.transition()
                    ...
                    .attr("x", function (d) {
                        ...
                        if (settings.activeTransform === 'linear') {
                            ...
                            switch (linkProjection) {
                                case "elbow":
                                    return project({x: d.target.x, y: d.source.y})[0];
                                    break;
                                case "diagonal":
                                case "direct":
                                    return ((project({x: d.source.x, y: d.source.y})[0] + project({
                                        x: d.target.x,
                                        y: d.target.y
                                    })[0]) / 2);
                                    break;
                    ...
                    .attr("y", function (d) {
                        ...
                        if (settings.activeTransform === 'linear') {
                            ...
                            switch (linkProjection) {
                                case "elbow":
                                    return project({x: d.target.x, y: d.source.y})[1];
                                    break;
                                case "diagonal":
                                case "direct":
                                    return ((project({x: d.source.x, y: d.source.y})[1] + project({
                                        x: d.target.x,
                                        y: d.target.y
                                    })[1]) / 2);
                                    break;
            ...
            nodeInfoSave: async function (nodeName, node) {
                ...
                if (nodeName === '') {
                    ...
                    * */
                    ...
                    if (imageUrl !== '') {
                        var image = '<a style="display: flex; justify-content: center;" href="' + imageUrl + '" target="_blank"><img src="' + imageUrl + '" style="width: 253px; height: 190px;"></a>';
                    } else {
                    ...
                    content += '<div style="display: flex; justify-content: center; padding-top: 15px;"><br><iframe src="' + mapLink + '" width="253" height="190" style="border:0;" allowFullScreen="" aria-hidden="false" tabIndex="0"></iframe>\n</div>';
            ...
            getSpeciesData: async function (speciesName) {
                return await axios.get(`http://localhost:4000/species?scientificName=${speciesName}`)
                    .then(response => {
